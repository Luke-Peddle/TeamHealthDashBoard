...
const ManagerPage = ({ project,  sprints, teamMembers, nonTeamMembers, projectId, velocityMetric, onCallMatrics, codeReviewMatrics,  pulseSurvey, darkMode, userId, role}) => {
